...
public class PhysicalObject extends GameObject {
    ...
    protected float friction = 0.9999f;
    //==================================================================================================
    ...
    public void setVelocityInDirection(float direction, float force) {
        setVelocity((float)Math.sin(Math.toRadians(direction))*force, (float)-Math.cos(Math.toRadians(direction))*force);
